...
public class ChatLoginPanel extends JPanel {
    ...
    void componentInit() throws Exception {
        ...
        addLabel(gridBag, "Which Room: ", SwingConstants.LEFT, 1, 7, 1, 1);
        ...
        _roomXField = new JTextField();
        addField(gridBag, _roomXField, 2, 7, 1, 1);
    ...
    private void connect() {
        ...
        String roomX = _roomXField.getText();
